...
Expandir una card para mostrar información adicional sin cambiar de pantalla.
...
- La transición entre card y detalle es muy fluida.
- Conserva el contexto visual.
- Evita navegar a otra pantalla.
...
- Reemplazar imágenes por contenido real de la app.
- Eliminar CTA "Play/Visit".
- Reemplazar CloseIcon por Phosphor Icons.
- Usar colores del sistema.
- Usar glass effect.
- Usar radius del sistema.
- Mantener AnimatePresence.
- Mantener layoutId para animación compartida.
- Cerrar con Escape.
- Cerrar al tocar fuera.
- Respetar prefers-reduced-motion.
- No bloquear el scroll de la página innecesariamente.
...
- Ver información de un reporte.
- Ver movimientos de un paquete.
