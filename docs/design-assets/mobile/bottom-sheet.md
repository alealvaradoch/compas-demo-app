...
- Convertir de TypeScript a JavaScript si aplica.
- Adaptar al tema claro del proyecto.
- Aplicar glass effect del sistema.
- Usar radius definido en `002-radius.md`.
- Usar colores del sistema.
- Reemplazar cualquier icono por Phosphor Icons.
- Mantener el gesto de arrastrar para cerrar.
- Permitir cerrar tocando el backdrop.
- Respetar `prefers-reduced-motion`.
- Mantener compatible con móvil.
